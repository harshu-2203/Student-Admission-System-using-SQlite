...
class StudentLoginVC: UIViewController {
    ...
    private let bgimage: UIImageView = {
       ...
       private let vcbutton : UIButton = {
           ...
           vc_button.layer.cornerRadius = 90
           return vc_button
       } ()
       ...
       @objc func redirect()
       {
        ...
        else
        {
            for i in 0..<stdcnt
            {
                ...
                {
                    let alert = UIAlertController(title: "Please Enter Correct information", message: "Incorrect Username Or Password", preferredStyle: .alert)
